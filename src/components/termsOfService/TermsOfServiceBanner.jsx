      ...
      <div className="bg-customSky m-8 w-[85%] h-52 flex items-center relative">
        {loading ? (
          <div className="animate-pulse w-full h-full flex items-center justify-center">
            <div className="bg-gray-300 w-2/3 h-8 rounded-md"></div>
          </div>
        ) : (
            ...
            <span className="text-white text-5xl font-bold">
              ...
              >
                ...
                <path
                  ...
                  fill="#FF8030"
                />
                <rect x="35" y="30" width="30" height="4" fill="#ffffff" rx="2" />
                <rect x="35" y="40" width="30" height="4" fill="#ffffff" rx="2" />
                <rect x="35" y="50" width="20" height="4" fill="#ffffff" rx="2" />
                <path
