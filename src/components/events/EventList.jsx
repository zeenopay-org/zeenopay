  ...
  const renderSkeletonLoader = () => (
    <div className="bg-customDarkBlue text-white rounded-3xl shadow-md overflow-hidden flex flex-col flex-shrink-0">
      ...
      <div className="pl-4 pr-4 flex flex-col flex-grow">
        <div className="h-6 w-3/4 bg-gray-500 animate-pulse rounded-full mt-4"></div>
        <div className="h-4 w-3/6 bg-gray-500 animate-pulse rounded-full mt-2"></div>
        <div className="flex justify-between items-center rounded-full mt-auto">
          <div className="h-4 w-1/4 bg-gray-500 animate-pulse rounded-full"></div>
          <div className="h-8 m-1 w-20 bg-gray-500 animate-pulse rounded-full"></div>
        </div>
      </div>
    </div>
  );
