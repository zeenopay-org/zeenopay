...
useEffect(() => {
  ...
  return (
    <div className="bg-customBlue max-w-full py-8 px-4 flex flex-col items-center pb-20">
      ...
      <div
        className={`w-full ${pop ? "blur-md pointer-events-none" : ""} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-5 max-w-[90%]`}
      >
        {loading
          ? Array(6)
              .fill()
              ...
              >
                ...
                <div className="relative w-full h-60 lg:h-[300px] md:h-60 overflow-hidden rounded-2xl mb-4 bg-gray-300">
                  <img
                    ...
                    className="absolute top-0 left-0 w-full h-full object-cover z-10 opacity-0 transition-opacity duration-700 rounded-2xl"
